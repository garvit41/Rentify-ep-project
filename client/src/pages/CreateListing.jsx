...
import { createListing } from "../services/ListingsService"; // ✅ service layer
...
const CreateListing = () => {
	...
	const handlePost = async (e) => {
		...
		try {
			...
			Object.entries(formLocation).forEach(([key, value]) => {
			...
			Object.entries(formDescription).forEach(([key, value]) => {
				listingForm.append(key, value);
			});
			photos.forEach((photo) => listingForm.append("listingPhotos", photo));

			const response = await createListing(listingForm); // ✅ service layer call
